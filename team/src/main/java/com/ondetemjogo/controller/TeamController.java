...
import com.ondetemjogo.service.TeamService;
...
public class TeamController {
	...
	@RequestMapping(value = { "/search",
			"/search/{search}" }, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	public ResponseEntity<Set<TeamDTO>> getEventsWithSearch(
